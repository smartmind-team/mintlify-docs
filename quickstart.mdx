...
First, download the dataset, which contains user reviews of a product, running the following command in your terminal, or by visiting the dataset link [here](https://github.com/smartmind-team/assets/blob/main/datasets/comments_data.csv) and downloading the file manually.
...
To get started with querying your data in ThanoSQL, let's write a simple SQL query to retrieve all records from your table.
