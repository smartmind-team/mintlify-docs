...
2. **Upload Data to Tables**:
    ...
    ```
    On execution, we get: 
    ![Agents Table](/images/use-cases/use-case-1/table-01.png)
    ...
    ```
    On execution, we get: 
    ![Calls Table](/images/use-cases/use-case-1/table-02.png)
    ...
    ```
    On execution, we get: 
    ![Transcript Table](/images/use-cases/use-case-1/table-03.png)
...
3. **Classify Conversations and Aggregate Metrics**:
    ...
    - **Using Mistral LLM**:
      ...
      ```
      On execution, we get: 
      ![Result 1](/images/use-cases/use-case-1/result-01.png)
    ...
    - **Using OpenAI GPT-4o**:
      ...
      ```
      On execution, we get: 
      ![Result 2](/images/use-cases/use-case-1/result-02.png)
